...
## 1. Setup Zoho Recruit (Sandbox/Trial)
...
5. **Generate Refresh Token:**
    * In your browser, visit this URL (replace `{YOUR_CLIENT_ID}`):
        ...
        https://accounts.zoho.com/oauth/v2/auth?scope=ZohoRecruit.modules.ALL&client_id={YOUR_CLIENT_ID}&response_type=code&access_type=offline&redirect_uri=http://localhost:3000/callback

    * Click **Accept**. You will be redirected to a blank page. 
    * Look at the address bar at the top of your browser. It will look like this: http://localhost:3000/callback?code=1000.zw7...&location=us
